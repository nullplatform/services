        ...
        "elements": [
          {
            ...
            "options": {
              ...
              "detail": {
                "type": "VerticalLayout",
                "elements": [
                  {"type": "Control", "label": "Scope", "scope": "#/properties/scopes"},
          ...
          "items": {
            ...
            "properties": {
              "scopes": {
                "type": "string",
                "title": "Scope",
                "description": "Scope name this rule applies to (e.g. develop, staging, prod). Add multiple rules for multiple scopes.",
                "editableOn": ["create", "update"]
              },
              "methods": {
                "type": "array",
