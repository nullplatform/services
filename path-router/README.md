...
module "service_definition_path_router" {
  ...
  repository_branch = "feature/path-router"       # or main once merged
  repository_token  = var.repository_token
  service_path      = "path-router"                # path within the repo
...
module "scope_channel_association" {
  for_each = toset([
    "/path-router/container-scope-override",
  ...
  override_repo_path       = "/root/.np/nullplatform/services"
